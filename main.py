...
# "dig more", or "render this game for this object"
...
class Board:
    ...
    def make_new_board(self):
        ...
        while bombs_planted < self.num_bombs:
            ...
            col = loc % self.dim_size  # we want the remainder to tell us what index in thet row to loc

            if board[row][col] == '*':
                # this means we've actually plant a bomb there already so keep going
                continue
    ...
    def assign_values_to_board(self):
        ...
        # many neighboring bombs there are, we can precompute these and it'll save us some
        # effort checking what's around the board later on
        for r in range(self.dim_size):
            for c in range(self.dim_size):
                if self.board[r][c] == '*':
                    # it is already a bomb we don't have to calculate anything
                    continue
...
if __name__ == '__main__':  # good practise
    play()
